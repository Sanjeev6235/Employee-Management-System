...
function Login({handleLogin}) {
  ...
  return (
    <div className='flex items-center justify-center w-screen h-screen bg-[#1c1c1c]'>
            <form onSubmit={handleSubmit} className='flex flex-col items-center justify-center gap-6 border-2 border-blue-400 rounded-xl w-[30%] h-[45%] px-10  sm:w[80%] sm:h[50%] sm:px-5'>
